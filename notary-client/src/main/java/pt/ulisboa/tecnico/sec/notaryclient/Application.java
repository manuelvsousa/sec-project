...
//        CitizenCard.getInstance().getCertificate();
        ...
        PrivateKey pk3 = KeyReader.getInstance().readPrivateKey("user3", "password3");
        NotaryClient nc3 = new NotaryClient("user3", pk3);
        ...
        System.out.println(nc2.intentionToSell("good1"));
        System.out.println(nc2.transferGood("good1","user3"));
        System.out.println(nc3.getStateOfGood("good1").getOwnerID());
